...
- **:uid SE REFIERE AL ID REGISTRADO EN MONGO DB DEL MODULO AL QUE HACE REFERENCIA LA RUTA EJEMPLO:products/:uid ID REGISTRADO DE CUALQUIER PRODUCTO**
- **LAS FACTURAS SE GENERAN AUTOMATICAMENTE AL PAGAR EL CARRITO Y SE ALMACENA EN EL DIRECTORIO "public/uploads/bills"**
- **LA DATA SE ALAMACENA EN EL DIRECTORIO "configs" en la carpeta "data"**
- **LA COLECCION DE ENDPOINTS DEL API SE ALMACENA EN EL DIRECTORIO "configs"**

## 🔐 PROTECCION DE LAS RUTAS DEL API EN LOS ENDPOINTS 🔐
## 👨🏻‍💻 PARA LOS ENDPOINTS QUE PUEDE EJECUTAR EL ADMIN 👨🏻‍💻
## 🔑 (ADMIN_ROLE) 🔑
- **NOS DIRIJIMOS A LA PARTE "Authorization"**
- **LUEGO EN Auth Type**
- **SELECCIONAMOS BEARER TOKEN**
- **Y ENVIAMOS EL TOKEN QUE RECIBIMOS COMO RESPUESTA AL LOGEARNOS COMO ADMIN**
## 🙋🏻‍♂️ PARA LOS ENDPOINTS QUE PUEDE EJECUTAR EL CLIENTE 🙋🏻‍♂️
## 🔑 (CLIENT_ROLE) 🔑
- **NOS DIRIJIMOS A LA PARTE "Authorization"**
- **LUEGO EN Auth Type**
- **SELECCIONAMOS BEARER TOKEN**
- **Y ENVIAMOS EL TOKEN QUE RECIBIMOS COMO RESPUESTA AL LOGEARNOS COMO CLIENTE**
## COMO SABER QUE ENDPOINTS SON DE ADMIN Y CUALES DE CLIENTE
- **EN LOS VALIDADORES DE CADA MODULO ENCONTRARÁS**
- **VALIDADOR DE CADA ENDPOINT**
- **ENCONTRARÁS  validateJWT**
- **Y SI EL ENDPOINT ES SOLO DE ADMIN SALDRA "hasRoles("ADMIN_ROLE")"**
- **ESTO SIGNIFICA QUE SOLO ADMINS PUEDE EJECUTAR DICHOS ENDPOINTS**
- **Y SI EL ENDPOINT ES SOLO DE CLIENTES SALDRA "hasRoles("CLIENT_ROLE")"**
- **ESTO SIGNIFICA QUE SOLO CLIENTES PUEDE EJECUTAR DICHOS ENDPOINTS**
## 👨🏻‍💻 🙋🏻‍♂️ SI LOS ADMINS Y CLIENTES PUEDEN EJECUTAR LOS ENDPOINTS 👨🏻‍💻 🙋🏻‍♂️
- **EN LOS VALIDADORES DE CADA MODULO ENCONTRARÁS**
- **VALIDADOR DE CADA ENDPOINT**
- **ENCONTRARÁS  validateJWT**
